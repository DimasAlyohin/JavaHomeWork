    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            switch (action) {
                ...
                case "sort": {
                    System.out.println("Выберите критерий сортировки: (name/birth/edit)");
                    String s = act.nextLine();
                    ...
                    switch (sort) {
                        ...
                        case "birth":
                            contacts.stream()
                                    .sorted(Comparator.comparing(Contact::getBirth))
                                    .forEach(System.out::println);
                            System.out.println("сортировка завершена");
                        case "edit":
                            contacts.stream()
                                    .sorted(Comparator.comparing(Contact::getEditTime))
                                    .forEach(System.out::println);
                            System.out.println("сортировка завершена");
                        default:
